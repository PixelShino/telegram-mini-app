    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-4">Настройка Telegram Mini App</h1>
          <p className="text-gray-600">Создайте тестовые данные для проверки работы магазина</p>
        </div>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Создаст тестовый магазин с товарами, пользователем и заказом для проверки функциональности
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              {result && (
                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <h3 className="font-semibold text-green-800 mb-2">Успешно создано!</h3>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Полезные ссылки для тестирования и настройки</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Используйте этот URL в настройках Mini App</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="p-4 bg-blue-50 rounded-lg">
                <h4 className="font-semibold mb-2">URL для BotFather:</h4>
                <div className="bg-white p-3 rounded border">
                  <code className="text-sm break-all">{shopUrl}</code>
                </div>
                <div className="mt-3 flex gap-2">
                  <Button variant="outline" size="sm" onClick={() => navigator.clipboard.writeText(shopUrl)}>
                    Копировать URL
                  </Button>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Убедитесь, что Supabase настроен правильно</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className={process.env.NEXT_PUBLIC_SUPABASE_URL ? "text-green-600" : "text-red-600"}>
                    {process.env.NEXT_PUBLIC_SUPABASE_URL ? "Настроен" : "Не настроен"}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>NEXT_PUBLIC_SUPABASE_ANON_KEY:</span>
                  <span className={process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ? "text-green-600" : "text-red-600"}>
                    {process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ? "Настроен" : "Не настроен"}
                  </span>
                </div>
              </div>
            </CardContent>
